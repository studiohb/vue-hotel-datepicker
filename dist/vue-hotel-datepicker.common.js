...
/* harmony default export */ var Dayvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    dayClass: function dayClass() {
      ...
      if (this.isCheckOutDay && !this.isHovered || this.isCurrentCheckOutCandidate) classes.push(this.cssClass('last-day-selected')); // Half-days
...
var component = normalizeComponent(
  ...
  Dayvue_type_template_id_6cd64d25_lang_pug_render,
  Dayvue_type_template_id_6cd64d25_lang_pug_staticRenderFns,
  false,
  null,
  null,
  null
